...
void BASE64_EXPORT base64_encode(const char *src, size_t srclen, char *out,
...
void BASE64_EXPORT base64_stream_encode_init(struct base64_state *state,
                                             int flags);
...
void BASE64_EXPORT base64_stream_encode(struct base64_state *state,
 ...
 * often be zero). */
void BASE64_EXPORT base64_stream_encode_final(struct base64_state *state,
                                              char *out, size_t *outlen);
 ...
 * size of the input. See above for `flags`, set to 0 for default operation: */
int BASE64_EXPORT base64_decode(const char *src, size_t srclen, char *out,
                                size_t *outlen, int flags);

/* Call this before calling base64_stream_decode() to init the state. See above
 * for `flags`; set to 0 for default operation: */
void BASE64_EXPORT base64_stream_decode_init(struct base64_state *state,
                                             int flags);
...
int BASE64_EXPORT base64_stream_decode(struct base64_state *state,
                                       const char *src, size_t srclen,
                                       char *out, size_t *outlen);
